...
function CartScreen(props) {
    ...
    const qty = props.location.search? Number(props.location.search.split("=")[1]):1; /* to search for the qty in the url, converting the string into num, spliting the string at = sign and choosing 1 character from the right*/
